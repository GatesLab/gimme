...
#'  \itemize{
#'  \item{allPathSummaryCounts} {Contains summary count information for paths identified at the individual-level.}
#'  \item{allPathEstimates} {Contains estimate, standard error, p-value, and z-value for each path for each individual}
#'  \item{summaryFit} {Contains model fit information for individual-level models. }
