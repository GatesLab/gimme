...
#' Each file must contain one matrix for each individual containing a T (time) by 
#' p (number of variables) matrix where the columns represent variables and
#' the rows represent time.
#' @param out The path to the directory where the results will be stored. This must be 
#' generated by the user prior to running the function.
...
print.gimmep <- function(x, file = NULL, ...){
  if (is.null(file)) {
    cat("Please specify a file id.")
...
coef.gimmep <- function(x, file = NULL, ...){
  if (is.null(file)) {
    cat("Please specify a file id.")
  } else {
...
summary.gimmep <- function(x, file = NULL, ...){
  if (is.null(file)) {
    cat("Please specify a file id.")
  } else {
