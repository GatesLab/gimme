...
The GIMME algorithm is a continually maintained R package, \textit{gimme}.
...
5. If all this is correct, please email the error you received, code used to run *gimme*, and the data (we promise not to use it or share it) to: gimme@unc.edu. 
